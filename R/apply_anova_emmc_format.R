#' Apply ANOVA EMM Contrasts Format
#'
...
#'
#' @export
apply_anova_emmc_format <- function(
  ...
  # Header style
  header_variable_bottom_style <- openxlsx::createStyle(
    textDecoration = "bold",
    border = "bottom"
  )
  ...
  header_italic_style <- openxlsx::createStyle(
  ...
  openxlsx::addStyle(wb,
                     ...
                     cols = (start_col + mod_col - 2):(start_col + mod_col - 1),
                     rows = start_row + 1)
  openxlsx::addStyle(wb,
                     sheet = sheet,
                     style = header_ci_style,
                     cols = (start_col + mod_col - 12):(start_col + mod_col - 10),
                     rows = start_row + 1)
  openxlsx::addStyle(wb,
                     sheet = sheet,
                     style = header_ci_style,
                     cols = (start_col + mod_col - 9):(start_col + mod_col - 7),
                     rows = start_row + 1)
  
  openxlsx::addStyle(wb,
                     sheet = sheet,
                     style = header_variable_bottom_style,
                     cols = start_col,
                     rows = start_row + 2)
  openxlsx::addStyle(wb,
                     sheet = sheet,
  ...
  openxlsx::addStyle(wb,
                     ...
                     cols = (start_col + mod_col - 14):(start_col + mod_col - 13),
                     rows = start_row + 2)
  ...
  openxlsx::addStyle(wb,
                     ...
                     style = body_style,
                     gridExpand = TRUE,
                     cols = (start_col + 3):(start_col + mod_col - 1),
  ...
  openxlsx::addStyle(wb,
                     ...
                     style = body_center_style,
                     gridExpand = TRUE,
                     cols = c((start_col + 1):(start_col + 2),
                              (start_col + 5),
                              (start_col + 10),
                              (start_col + 13):(start_col + 15)),
                     rows = (start_row + 3):(start_row + 1 + mod_row))
