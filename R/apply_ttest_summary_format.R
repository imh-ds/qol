...
#'
#' @export
apply_ttest_sum_format <- function(
  ...
  openxlsx::addStyle(wb,
                     sheet = sheet,
                     style = header_ci_style,
                     cols = (start_col + mod_col - 10):(start_col + mod_col - 9),
                     rows = start_row + 1)
  ...
  openxlsx::addStyle(wb,
                     ...
                     style = body_style,
                     gridExpand = TRUE,
                     cols = c((start_col + 2):(start_col + 8),
                              (start_col + 10):(start_col + mod_col - 1)),
  ...
  #                    style = body_style,
  #                    gridExpand = TRUE,
  #                    cols = (start_col + 10):(start_col + mod_col - 1),
  #                    rows = (start_row + 3):(start_row + 1 + mod_row))
