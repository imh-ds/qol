...
#'
#' @export
apply_anova_report_format <- function(
  ...
  openxlsx::addStyle(wb,
                     ...
                     cols = (start_col + mod_col - 2 - es_length):(start_col + mod_col - 1 - es_length),
                     rows = start_row + 1)
  ...
  openxlsx::addStyle(wb,
                     ...
                     gridExpand = TRUE,
                     cols = (start_col + 1):(start_col + 1 + eff_length),
                     rows = (start_row + 2):(start_row + 1 + mod_row))
