...
#' metrics for a chi-square independent proportions test. Automatically applies
#' holm p adjustment to multiple comparisons. Returns model statistic and also
